...
void Camera::getWorldPos(int worldPos[])
{
	...
	worldPos[0] = (Position.z / 1.0f - (int)(Position.z / 1.0f)) == 0 ? (int)(Position.z / 1.0f) : (int)(Position.z / 1.0f) + 1;//ÏòÓÒ
	worldPos[1] = (Position.x / 1.0f - (int)(Position.x / 1.0f)) == 0 ? (int)(Position.x / 1.0f) : (int)(Position.x / 1.0f) + 1;//height
	worldPos[2] = (Position.y / 1.0f - (int)(Position.y / 1.0f)) == 0 ? (int)(Position.y / 1.0f) : (int)(Position.y / 1.0f) + 1;//ÏòÇ°
}
